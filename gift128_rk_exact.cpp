...
for(int i=0; i<T; i++){
  ...
  //---------------initial-----------------//
  //cout << "(assert (= a24_0 (_ bv6 4)))" << endl;
  //cout << "(assert (= a25_0 (_ bv15 4)))" << endl;
  //cout << "(assert (= b13_8 (_ bv6 4)))" << endl;
  //cout << "(assert (= b3_9 (_ bv6 4)))" << endl;
  //cout << "(assert (= b11_9 (_ bv5 4)))" << endl;
  //cout << "(assert (bvugt (bvxor (_ bv8 4) b26_0) (_ bv0 4)))" << endl;

  //----------------bounds-----------------//
  cout << "(assert (= weight1 ";
  for(int i=0; i<T; i++){
  for(int j=0; j<=31; j++){
    if((i+1==T) && (j==31)) cout << "(concat (_ bv0 15) pon31_"<<T-1<<")";
  ...
  for(int i=0; i<T; i++){
  for(int j=0; j<=31; j++){
    if((i+1==T) && (j==31)) cout << "(concat (_ bv0 15) ptw31_"<<T-1<<")";
  ...
  for(int i=0; i<T; i++){
  for(int j=0; j<=31; j++){
    if((i+1==T) && (j==31)) cout << "(concat (_ bv0 15) pth31_"<<T-1<<")";
